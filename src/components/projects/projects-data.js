const projectData = [
  {
    ...
    story: 'This portfolio is my first project as a freelance full-stack developer. Working with the client using React for the front-end and Ruby on Rails for the back-end, I created a multipage gallery and accompanying administrative web app.'
  },
  {
    id: 2,
    name: 'Church Website',
